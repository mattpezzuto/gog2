...
export class Refresh extends Creature {
    public override clone(): Creature {
        return new Refresh(this.getGlobalBuffService(), this.getPlayerId());
    }
    ...
    override getCreatureStatsBaseline(): CreatureStats {
        ...
        tempCreatureStats.name = 'Refresh';
        ...
        tempCreatureStats.image = 'assets/images/' + 'refresh.png';
