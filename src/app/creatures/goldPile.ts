...
export class GoldPile extends Creature {
    public override clone(): Creature {
        return new GoldPile(this.getGlobalBuffService(), this.getPlayerId());
    }
    ...
    override getCreatureStatsBaseline(): CreatureStats {
        ...
        tempCreatureStats.name = 'Gold Pile';
        ...
        tempCreatureStats.image = 'assets/images/' + 'goldpile.png';
